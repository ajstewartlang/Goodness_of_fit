...
## Andrew's code - with just one predictor - first is explanation quality

### First combine the eye tracking and quesionnaire data
...
AIC(model_antecedent)
BIC(model_antecedent)
...
AIC(model_consequent)
BIC(model_consequent)
...
## Now with explanation probability as the predictor.
...
## Now to build models with both quality and probability as predictors.
